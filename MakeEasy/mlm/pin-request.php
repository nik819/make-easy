...
if(isset($_POST['pin_request']))
{
   ...
   $date = date("y-m-d");
    ...
    if($amount!=''){
        ...
        echo '<script>alert("plese Enter Amount 300 or 300+.");window.location.assign("pin-request.php");</script>';
    }
    }
    else{
...
<head>
    ...
    <title>MakeEasy - Pin Request</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><i class="fa fa-thumb-tack fa-fw"></i>Pin Request</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row --> 
                    ...
                    <div class="col-lg-4">
                        <form action="" method="POST" autocomplete="off">    
                            <div class="form-group">
                                <label>Amount</label>
                                <input type="text" name="amount"  class="form-control" placeholder="Enter Amount" oninvalid="this.setCustomValidity('Enter Amount Only Digit')" oninput="setCustomValidity('')">
                            </div>
                            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <?php 
                            $i=1;
                            $query = mysqli_query($con,"select * from pin_request where email='$email' order by id asc");
