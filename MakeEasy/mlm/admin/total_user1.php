...
<head>
    ...
    <title>MakeEasy - Edit Member</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><i class="fa fa-edit"></i> Edit Member</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    	...
                    	<div class="table-responsive">
                        	<table class="table table-bordered table-striped">
                                       ...
                                       <form method="post">
                                            ...
                                            <label for="address">Under_Userid:</label>
                                            ...
                                            <div class="text-right mt-20">
                                                ...
                                                <input type="submit" value="Cancle" class="btn btn-danger" name="cancle">
                                            </div>
                                        </form>
                                        <?php
                                            if (isset($_POST["update"]))
                                            {
                                                ...
                                                echo"<script>alert('Update Successfully..');window.location.assign('total_user.php');</script>";
                                             }
                                             elseif(isset($_POST["cancle"]))
                                             {
                                                 echo"<script>window.location.assign('total_user.php');</script>";
                                             }
                                        ?>
                            </table>
                        </div>
