...
<head>
    ...
    <title>MakeEasy - View Pin Request</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><i class="fa fa-thumb-tack"> Admin - View pin request</i></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                      ...
                      <div class="table-responsive">
                          ...
                          <tr>
                                  ...
                                  <?php
                                      ...
                                      echo mysqli_num_rows(mysqli_query($con,"SELECT * FROM pin_request where status='close'"));
                                  ?>   &nbsp;Pin-Request send ........</td>
                                        </tr>
                              <tr>
                                  <th>Serial No</th>
                                ...
                                ?>      
                                       ...
                                       ?>
                                 <!-- <tr>
                                          <td colspan="6" align="center" class="danger" style="color: Red"><?php
                                        // echo mysqli_num_rows(mysqli_query($con,"SELECT id FROM pin_request"));
                                ?>   &nbsp;Pin Send Successfully.</td>
                                        </tr> -->
                                    <?php
                                           }
                                   ?>
